public class Main {
    public static void main(String[] args) {
        ...
        Oceano oceano1 = new Oceano ("Pacifico", 660 000 000);
        Pais pais1 = new Pais (59.11, "Italia")

        
        System.out.println(pizza1.getPreco());

        Animais animais1 = new Animais ("Réptil", "Crocodilo");
        System.out.println(animais1.getReino(), animais1.getNome());
        System.out.print(animais1.SetReino(String));
